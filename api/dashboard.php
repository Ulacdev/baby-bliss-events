...
function getDashboardStats()
{
    ...
    // Get recent booking activities from audit logs
    $result = $conn->query("SELECT id, user_name, activity, details, created_at FROM audit_logs WHERE (details LIKE '%booking%' OR activity IN ('Status Change', 'Create', 'Update', 'Delete', 'Booking Restored', 'Booking Permanently Deleted')) ORDER BY created_at DESC LIMIT 10");
    $recentActivities = [];
